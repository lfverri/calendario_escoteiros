...
let nav = 0;
let clicked = null;
let events = localStorage.getItem('events_4') ? JSON.parse(localStorage.getItem('events_4')) : [];
...
passwordSubmitButton.addEventListener('click', function () {
    if (passwordInput.value === correctPassword) {
        if (eventTitleInput.value) {
            ...
            localStorage.setItem('events_4', JSON.stringify(events));
...
function deleteEventFromList(event, listItem) {
    ...
    passwordSubmitButton.addEventListener('click', function () {
        if (passwordInput.value === correctPassword) {
            ...
            localStorage.setItem('events_3', JSON.stringify(events));
